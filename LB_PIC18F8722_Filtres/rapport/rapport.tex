...
\begin{document}
   ...
   \end{figure}
    ...
    Possible amélioration mais complique beaucoup la programmation. En plus, en 16kHz, on est vraiment à la limite des possibilités du processeur -> beaucoup d'interruptions en haute priorité -> les entrées et sorties risquent d'être extrêmement lentes


    A ajouter au grafcet : ledelay de l'echo est aussi mis à jour quand on met à jour la sampling frequency
