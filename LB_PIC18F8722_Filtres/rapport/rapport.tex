...
\begin{document}
   ...
   \end{figure}
    ...
    \subsubsection{Test : coefficient 2 (16kHz)}
    \subsubsection{Test : coefficient 4 (16kHz)}
    \subsubsection{Test : coefficient 8 (16kHz)}


    \subsubsection{Test : coefficient 2 (8kHz)}
    \subsubsection{Test : coefficient 4 (8kHz)}
    \subsubsection{Test : coefficient 8 (8kHz)}
